...
ICONS = sorted(set([
    ...
    # (record_voice_over, mic, headphones, check_circle, search, refresh, info,
    #  error, close, volume_up, image_not_supported, progress_activity,
    #  expand_more, expand_less, hourglass_empty ya están arriba)
    "graphic_eq", "mic_off", "search_off", "send", "stop", "celebration", "swap_horiz",
]))
